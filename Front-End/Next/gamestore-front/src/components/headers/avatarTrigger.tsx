    ...
    return (
        <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 transition-opacity">
                <div onClick={abrirMenu} className="w-9 h-9 bg-gray-800 text-white rounded-full flex items-center justify-center font-bold text-sm hover:opacity-80 cursor-pointer">
